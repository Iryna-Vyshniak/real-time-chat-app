...
import { useEditMessage } from '../../../shared/hooks/useEditMessage';
import useConversation from '../../../store/useConversation';

import Icon from '../../ui/Icon';

import RecordView from './message.data/media.recoder/MediaRecorder';

const MessagesBlockInput = ({ onCloseQuote, isShowQuotedMessage, quotedMessage }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    } else if (message || imgUrl || audioUrl || videoUrl) {
      await sendMessages({
        message,
        img: imgUrl,
        audio: audioUrl,
...
export default MessagesBlockInput;
